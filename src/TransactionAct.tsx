...
export default function Qa(){
    ...
    <p>お客様のご都合（イメージと異なる、注文間違い等）によるキャンセル、返品または交換は、原則としてお受けしておりません。あらかじめご了承ください。</p>

<p>ただし、以下のいずれかに該当する場合には、商品到着後30日以内にご連絡いただいたうえで、販売者の責任にて返品または交換に対応いたします。</p>
<p></p>
<ul>
...
<p className="pb-5">なお、事前のご連絡なく返送された場合や、商品到着後30日を経過した場合の対応はいたしかねますので、ご了承ください。</p>
    </Container>
    <Footer />
    </>
}